...
// Regenerated from
// .mboss/workflows/chat_retry_abort.workflow.json.
...
async function chatRetryAbortFn(evt: WebhookEvent): Promise<void> {
...
export const chatRetryAbort = DBOS.registerWorkflow(chatRetryAbortFn, {
  name: 'chat_retry_abort',
});
